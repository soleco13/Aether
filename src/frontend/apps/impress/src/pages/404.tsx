...
const Page: NextPageWithLayout = () => {
  ...
  return (
    <>
      <Head>
        <title>Страница не найдена - Aether</title>
        <meta property="og:title" content="Страница не найдена - Aether" key="title" />
      </Head>
      ...
      >
          ...
          >
            ...
            <Text
              ...
              `}
            >
              Похоже, страница, которую вы ищете, не существует или была перемещена в другое измерение эфира.
          </Text>
